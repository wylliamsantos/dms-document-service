...
class TimeStampManager {
     ...
     */
    TimeStampManager(String tsaUrl, int connectTimeout) throws NoSuchAlgorithmException, MalformedURLException {
        if (tsaUrl != null) {
            MessageDigest digest = MessageDigest.getInstance("SHA-256");
            this.tsaClient = new TSAClient(new URL(tsaUrl), null, null, digest, connectTimeout);
        }
    }
